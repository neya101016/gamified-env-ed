<?php
// Generate placeholder badge images if they don't exist
...
foreach ($badge_images as $filename => $color) {
    ...
    if (!file_exists($filepath)) {
        ...
        // Add initial letter using basic text function instead of TTF
...
echo "Badge image generation complete!";
?>